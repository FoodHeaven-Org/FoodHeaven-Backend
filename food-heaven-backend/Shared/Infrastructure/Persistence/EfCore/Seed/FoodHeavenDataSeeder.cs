...
public static class FoodHeavenDataSeeder
{
    ...
    private static async Task SeedMealsAsync(FoodHeavenContext context)
    {
        var meals = new[]
        {
            ...
            CreateMeal(3, "Pan con chicharron y tamal", "Pork sandwich with tamal", "Cerdo, camote, zarza criolla, tamal y cafe", "Pork, sweet potato, onion relish, tamal, and coffee", "https://www.eatperu.com/wp-content/uploads/2019/04/pan-con-chicharron-peruvian-pork-sandwich-1.jpeg", 690, 34, 76, 28, 1),
            ...
            CreateMeal(5, "Arroz con pollo", "Peruvian chicken rice", "Pollo, arroz verde, arvejas y salsa criolla", "Chicken, cilantro rice, peas, and onion relish", "https://www.comeperuano.pe/wp-content/uploads/2022/07/receta-de-arroz-con-pollo.jpg", 690, 38, 82, 22, 2),
            ...
            CreateMeal(10, "Cazuela peruana", "Peruvian cazuela soup", "Caldo de res con verduras, choclo y pasta", "Beef broth with vegetables, corn, and pasta", "https://www.eatperu.com/wp-content/uploads/2021/09/peruvan-sopa-a-la-minuta-minute-soup-recipe.jpg", 430, 26, 48, 12, 3),
            ...
            CreateMeal(101, "Avena con frutos rojos", "Oatmeal with berries", "Avena, leche, fresas, arandanos y nueces", "Oats, milk, strawberries, blueberries, and walnuts", "https://images.pexels.com/photos/5604832/pexels-photo-5604832.jpeg?auto=compress&cs=tinysrgb&w=900", 380, 14, 58, 11, 1),
        ...
        foreach (var retiredMealId in new[] { 106 })
        {
            var retiredMeal = await context.Comidas.FindAsync(retiredMealId);
            if (retiredMeal != null)
            {
                context.Comidas.Remove(retiredMeal);
            }
        }
