...
public static class FoodHeavenDataSeeder
{
    ...
    private static async Task SeedMealsAsync(FoodHeavenContext context)
    {
        var meals = new[]
        {
            ...
            CreateMeal(3, "Pan con chicharron y tamal", "Pork sandwich with tamal", "Cerdo, camote, zarza criolla, tamal y cafe", "Pork, sweet potato, onion relish, tamal, and coffee", "https://images.unsplash.com/photo-1550507992-eb63ffee0847?auto=format&fit=crop&w=900&q=80", 690, 34, 76, 28, 1),
            CreateMeal(4, "Pan con asado y jugo", "Roast beef sandwich with juice", "Pan con carne, papas y jugo de fresa", "Beef sandwich, potatoes, and strawberry juice", "https://images.unsplash.com/photo-1551782450-a2132b4ba21d?auto=format&fit=crop&w=900&q=80", 580, 30, 62, 22, 1),
            CreateMeal(5, "Arroz con pollo", "Chicken cilantro rice", "Pollo, arroz verde y salsa criolla", "Chicken, cilantro rice, and onion relish", "https://images.unsplash.com/photo-1604908176997-431f6688f1d9?auto=format&fit=crop&w=900&q=80", 720, 42, 82, 24, 2),
            CreateMeal(6, "Lomo saltado clasico", "Classic lomo saltado", "Carne salteada, arroz y papas doradas", "Sauteed beef, rice, and golden potatoes", "https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=900&q=80", 760, 40, 88, 28, 2),
            CreateMeal(7, "Aji de gallina", "Creamy chicken chili stew", "Pollo en crema de aji amarillo con arroz", "Chicken in yellow chili cream with rice", "https://images.unsplash.com/photo-1512058564366-18510be2db19?auto=format&fit=crop&w=900&q=80", 680, 33, 72, 27, 2),
            CreateMeal(8, "Seco de res con frejoles", "Beef stew with beans", "Res guisada, frejoles, arroz y papa", "Braised beef, beans, rice, and potato", "https://images.unsplash.com/photo-1600891964599-f61ba0e24092?auto=format&fit=crop&w=900&q=80", 790, 45, 90, 26, 2),
            ...
            CreateMeal(10, "Sopa criolla con carne", "Creole beef soup", "Caldo de tomate, fideos, carne y huevo", "Tomato broth, noodles, beef, and egg", "https://images.unsplash.com/photo-1547592166-23ac45744acd?auto=format&fit=crop&w=900&q=80", 520, 29, 50, 21, 3),
            ...
            CreateMeal(105, "Pollo a la plancha con quinua", "Grilled chicken with quinoa", "Pechuga de pollo, quinua y verduras salteadas", "Chicken breast, quinoa, and sauteed vegetables", "https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=900&q=80", 640, 48, 58, 19, 2),
            CreateMeal(106, "Estofado de pollo", "Chicken stew", "Pollo guisado con arroz integral y papa", "Chicken stew with brown rice and potato", "https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?auto=format&fit=crop&w=900&q=80", 610, 38, 66, 20, 2),
